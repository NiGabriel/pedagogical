 ...
 * @author IPRC KARONGI
 */
public class TeacherDocEdits extends HttpServlet {
...
"			    <h2> pedagogical document - Teacher document</h2>\n" +
"			</div>");
	    ...
	    out.print("<form action='TeacherDocUpdateServlet' method='post'>");
	    out.println("<div class=\"mb-3\">");
	    out.print("<input type ='hidden' name ='id1' value ='"+e.getDocid()+"'/>");
	    out.println("</div>");
	    out.println("<div class=\"mb-3\">");
	    out.print("Title:<input type='text' name='title1' class=\"form-control\" style=\"width: 270px;\" value='" + e.getDoctitle() + "' required/>");
	    out.println("</div>");
	    out.println("<div class=\"mb-3\">");
	    out.print("Author:<input type='hidden' name='author1' class=\"form-control\" style=\"width: 270px;\" value='" + e.getDocauthor() +"' required/>");
	    out.println("</div>");
	    ...
	    /*request.setAttribute("data", myId);
