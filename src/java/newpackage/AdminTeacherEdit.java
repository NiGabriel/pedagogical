 ...
 * @author IPRC KARONGI
 */
public class AdminTeacherEdit extends HttpServlet {
	...
	try (PrintWriter out = response.getWriter()) {
	    ...
	    out.println("<title>Admin - Edit teacher</title>");	    
	    out.println("</head>");
	    out.println("<body>");
	    
	    String idxs = request.getParameter("tid");
	    int myId = Integer.parseInt(idxs);

	    user e = UserDatabase.getTeacherById(myId);
	    
	    out.println("<div class=\"banner\"></div>");
	    out.println("<div class=\"main-content\">");
	    
	    out.println("<div class=\"card-header\">\n" +
"			    <h2> pedagogical document System - Modify teacher's data</h2>\n" +
"			</div>");
	    ...
	    out.print("<form action='TeacherEditServlet' method='post'>");
	    out.println("<div class=\"mb-3\">");
	    out.print("<input type ='hidden' name ='tid' value ='"+e.getTid()+"'/>");
	    out.println("</div>");
	    out.println("<div class=\"mb-3\">");
	    out.print("Names of teacher:<input type='text' name='tname' class=\"form-control\" style=\"width: 270px;\" value='" + e.getTname() + "'/>");
	    out.println("</div>");
	    out.println("<div class=\"mb-3\">");
	    out.print("Username:<input type='text' name='tuname' class=\"form-control\" style=\"width: 270px;\" value='" + e.getTuname() +"' pattern='^(([^<>()[\\]\\\\.,;:\\s@\"]+(\\.[^<>()[\\]\\\\.,;:\\s@\"]+)*)|(\".+\"))@((\\[[0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}\\.[0-9]{1,3}\\])|(([a-zA-Z\\-0-9]+\\.)+[a-zA-Z]{2,}))$' required/>");
	    out.println("</div>");
	    out.println("<div class=\"mb-3\">");
	    out.print("Password:<input type='text' name='tpass' class=\"form-control\" style=\"width: 270px;\" value='" + e.getTpass() +"' required pattern=\"(?=.*\\d)(?=.*[a-z])(?=.*[A-Z]).{6,}\"/>");
	    out.println("</div>");
	    out.println("<div class=\"mb-3\">");
	    out.print("Telephone:<input type='text' name='ttel' class=\"form-control\" style=\"width: 270px;\" value='" + e.getTtel() +"' pattern=\"^\\d{10}$\" required/>");
	    out.println("</div>");
