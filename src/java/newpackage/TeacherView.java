...
public class TeacherView extends HttpServlet {
	...
	try (PrintWriter out = response.getWriter()) {
	    ...
	    String idxs = request.getParameter("idp");
	    ...
	    String datap = "select * from teacherpendingdoc where id = '"+myId+"'";
...
"			</div>");
	    ...
	    out.println("</div>");
	    out.println("<div class=\"mb-3\">");
	    out.print("Author:<input type='text' name='authors' class=\"form-control\" style=\"width: 270px;\" value='" + rsp.getString("author") +"'/>");
	    out.println("</div>");
	     out.println("<div class=\"mb-3\">");
