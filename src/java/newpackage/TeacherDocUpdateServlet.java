 ...
 * @author IPRC KARONGI
 */
public class TeacherDocUpdateServlet extends HttpServlet {
	...
	try (PrintWriter out = response.getWriter()) {
	    ...
	    out.println("<html>");
	    out.println("<head>");
	    out.println("<title>Servlet TeacherDocUpdateServlet</title>");	    
	    out.println("</head>");
	    out.println("<body>");
	    ...
	    int status = UserDatabase.updateTeacherDoc(e);
	    if (status > 0) {
